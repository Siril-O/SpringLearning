...
public class TestPizzaRepository implements PizzaRepository {
	...
	private List<Pizza> pizzas = Arrays.asList(new Pizza(1, "Salami", 100.3,
			PizzaType.Meat), new Pizza(2, "Seal", 200.45, PizzaType.Sea),
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ua.epam.edu.pizza.repository.PizzaRepository#getPizzaByID(int)
	 */
